...
nome_arquivo = "grafo_nao_ponderado.txt"

# Usamos um set para registrar as arestas já criadas e evitar duplicatas.
arestas_existentes = set()

print(f"Gerando arquivo '{nome_arquivo}' com um grafo conexo (sem pesos)...")
try:
    with open(nome_arquivo, 'w') as f:
        # Escreve a primeira linha com a quantidade de vértices
